...
export const metadata = {
    title: "About",
    alternates: {
      canonical: "https://carcheckstatus.co.uk/about",
    },
    openGraph: {
      locale: "en_gb",
      type: "website",
...
const page = () => {
  return (
    <>
      <section class="py-12 bg-white mx-auto max-w-5xl w-full sm:px-6 lg:px-8">
        <div class="container px-4 mx-auto">
          ...
          {/* <div class="mb-10 mx-auto overflow-hidden rounded-lg"></div> */}
          <div class="mx-auto">
            <p class="mb-8 pb-10 text-base text-coolGray-500 border-b border-coolGray-100"></p>
            <div>
              At Car Check Status, we are dedicated to providing UK residents
              with a reliable and free source to check car history, MOT status,
              and vehicle details. Our team is comprised of seasoned
              professionals who possess extensive knowledge and experience in
              car registrations, vehicle history checks, and DVLA regulations.
              We are passionate about helping you make informed decisions about
              your vehicle, whether you are a car owner or a prospective buyer.
            </div>
            <p></p>
            <h3 class="mb-4 text-2xl md:text-3xl font-semibold text-coolGray-800">
              What is Our Motto?
            </h3>
            <p class="mb-4 text-base md:text-base text-coolGray-500"></p>
            <div>
              Our motto is to offer a seamless and accessible platform for
              everyone to obtain crucial information about their vehicles. We
              understand the importance of having accurate and up-to-date
              details, and we strive to deliver this information efficiently and
              effortlessly.
            </div>
            <h3 class="mb-4 text-2xl md:text-3xl font-semibold text-coolGray-800">
              Our Services
            ...
            <div class="mb-6 p-6 border-l-2 border-green-500">
              {/* <p class="mb-4 text-xl md:text-2xl leading-tight text-coolGray-800"></p> */}
              <div>
                <b className="text-lg">Free Car History Check</b>
                <p>
                  Get detailed information about your vehicle’s past, including
                  previous ownerships, accidents, and more.
                </p>
              </div>
              <div>
                <b className="text-lg">MOT Status Check</b>
                <p>
                  Easily verify the MOT status of your car to ensure it meets
                  road safety and environmental standards.
                </p>
              </div>
              <div>
                <b className="text-lg">DVLA Check</b>
                <p>
                  Access essential details registered with the DVLA, ensuring
                  you have all the necessary information about your vehicle.
                </p>
              </div>
            </div>
          </div>
          <p class="mb-6 text-base md:text-base text-coolGray-500">
            While we provide these comprehensive services for free, it is
            important to note that we are not affiliated with the official
            government MOT check website.
          </p>
          <div class="mb-4 max-w-max overflow-hidden rounded-md"></div>
        </div>
      </section>
      <section class="py-8 -mt-10 bg-white mx-auto max-w-5xl w-full sm:px-6 lg:px-8">
        <div class="container px-4 mx-auto">
          <div class="flex flex-wrap mb-12 lg:mb-12 justify-between items-center">
            <div class="w-full mb-10 lg:mb-0">
              ...
              <p class="text-base text-coolGray-500">
                ...
                have. Feel free to reach out to us during our office hours:
              </p>
            </div>
          </div>
          ...
          <p class="text-base text-coolGray-500">
            Thank you for choosing Car Check Status. We look forward to helping
            you stay informed and confident about your vehicle decisions.
          </p>
        </div>
      </section>
    </>
