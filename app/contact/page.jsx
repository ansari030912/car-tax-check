export const metadata = {
  title: "Contact Us",
  alternates: {
    canonical: "https://carcheckstatus.co.uk/contact",
  },
  openGraph: {
    locale: "en_gb",
    type: "website",
...
const page = () => {
  return (
    <section class="py-8 bg-white mx-auto max-w-5xl w-full sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap mb-12 lg:mb-12 justify-between items-center">
          <div class="w-full mb-10 lg:mb-0">
            ...
            <p class="text-lg md:text-xl text-coolGray-500 font-medium">
              Car Check Status is committed to providing you with the best
              possible service and support. Whether you have questions about our
              services, need assistance with a car check, or have any other
              inquiries, we are here to help. Please feel free to contact us
            ...
            <div class="flex flex-wrap ">
              <div class="w-full md:w-1/2 mb-10">
                <div class="mx-auto">
                  ...
                  <a
                    class="text-lg md:text-xl text-coolGray-500 hover:text-coolGray-600 font-medium"
                    href="mailto:#"
                  >
