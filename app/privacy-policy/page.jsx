export const metadata = {
  ...
  alternates: {
    canonical: "https://carcheckstatus.co.uk/privacy-policy",
  },
  openGraph: {
    locale: "en_gb",
    type: "website",
    ...
    <>
      <section className="py-12 bg-white mx-auto max-w-5xl w-full sm:px-6 lg:px-8">
        <div className="container px-4 mx-auto">
          ...
          <div className="mx-auto">
            <div>
              At Car Check Status, we are committed to protecting your privacy
            ...
            <div>
              ...
              <ul>
                <li>
                  Personal Information: When you contact us or use our services,
                  we may collect personal details such as your name, email
                  address, phone number, and any other information you provide.
                </li>
                <li>
                  Vehicle Information: To provide our services, we may collect
                  information related to your vehicle, such as registration
                  number, MOT status, and history.
                </li>
                <li>
                  Usage Data: We may collect data on how you interact with our
            ...
            <div>
              ...
              release your information when we believe it is appropriate to
              comply with the law, enforce our site policies, or protect our or
              other&apos;s rights, property, or safety.
            </div>
            <h3 className="mb-4 text-2xl md:text-3xl font-semibold text-coolGray-800">
            ...
            <div>
              ...
              implement appropriate measures to protect it from unauthorised
            ...
            <div>
              ...
              <ul>
                ...
                <li>
                  ...
                  organisation or directly to you
                </li>
              </ul>
            ...
            <div>
              ...
              changes. Changes to this Privacy Policy are effective when posted
              on this page.
            </div>
          </div>
        </div>
      ...
      <section class="py-8 -mt-10 bg-white mx-auto max-w-5xl w-full sm:px-6 lg:px-8">
        <div class="container px-4 mx-auto">
          ...
          <p class="text-base text-coolGray-500">
            Thank you for using Car Check Status. We are committed to protecting
            your privacy and ensuring a safe online experience.
          </p>
        </div>
      </section>
    </>
