...
export const metadata = {
  ...
  alternates: {
    canonical: "https://carcheckstatus.co.uk/terms-and-conditions",
  },
  openGraph: {
    locale: "en_gb",
    type: "website",
...
const page = () => {
  return (
    <>
      <section className="py-12 bg-white mx-auto max-w-5xl w-full sm:px-6 lg:px-8">
        <div className="container px-4 mx-auto">
          ...
          <div className="mx-auto">
            <div>
              Welcome to Car Check Status. These terms and conditions outline
              the rules and regulations for the use of our website, located at{" "}
              <Link href="/" className="text-blue-600 hover:underline">
                https://carcheckstatus.co.uk/
              </Link>
              .
            </div>
            <div>
              By accessing this website, we assume you accept these terms and
              conditions. Do not continue to use Car Check Status if you do not
              agree to all of the terms and conditions stated on this page.
            </div>
            <h3 className="mb-4 text-2xl md:text-3xl font-semibold text-coolGray-800 mt-4">
              Terminology
            </h3>
            <div>
            ...
            <div>
              Eligibility: By using our services, you confirm that you are at
              least 18 years of age.
            </div>
            <div>
              Services Provided: We offer free car history checks, MOT status
              checks, and DVLA checks. We are not affiliated with the official
              government MOT check website.
            </div>
            <div>
              Accuracy of Information: While we strive to ensure the information
              provided on our website is accurate and up-to-date, we do not
              guarantee the completeness, reliability, or accuracy of this
              information. The use of any information or materials on this
            ...
            <div>
              Unless otherwise stated, Car Check Status and/or its licensors own
              the intellectual property rights for all material on Car Check
              Status. All intellectual property rights are reserved. You may
              access this from Car Check Status for your own personal use
              subject to restrictions set in these terms and conditions.
            </div>
            <div>
              You must not:
              <ul>
                <li>Republish material from Car Check Status</li>
                <li>
                  Sell, rent, or sub-license material from Car Check Status
                </li>
                <li>
                  Reproduce, duplicate, or copy material from Car Check Status
                </li>
                <li>Redistribute content from Car Check Status</li>
              </ul>
            </div>
            <h3 className="mb-4 text-2xl md:text-3xl font-semibold text-coolGray-800 mt-4">
              User Conduct
            ...
            <div>
              ...
              or prohibited by these terms and conditions. You agree not to:
              <ul>
                <li>
                ...
                <li>
                  ...
                  robots, spiders, or offline readers, to access the website in
                  a manner that sends more request messages to the Car Check
                  Status servers than a human can reasonably produce in the same
                  period by using a conventional web browser.
                </li>
              </ul>
            </div>
            <h3 className="mb-4 text-2xl md:text-3xl font-semibold text-coolGray-800 mt-4">
            ...
            <div>
              In no event shall Car Check Status, nor any of its officers,
              directors, and employees, be held liable for anything arising out
              of or in any way connected with your use of this website. Car
              Check Status, including its officers, directors, and employees,
            ...
            <div>
              You hereby indemnify to the fullest extent Car Check Status from
              and against any and all liabilities, costs, demands, causes of
              action, damages, and expenses (including reasonable
              solicitor&apos;s fees) arising out of or in any way related to
            ...
            <div>
              Car Check Status is permitted to revise these terms at any time as
            ...
            <div>
              ...
              the laws of the United Kingdom, and you submit to the
              non-exclusive jurisdiction of the courts located in the United
              Kingdom for the resolution of any disputes.
            </div>
          </div>
        </div>
      </section>
      <section class="py-8 -mt-10 bg-white mx-auto max-w-5xl w-full sm:px-6 lg:px-8">
        <div class="container px-4 mx-auto">
          <div class="flex flex-wrap mb-12 lg:mb-12 justify-between items-center">
            <div class="w-full mb-10 lg:mb-0">
              <h1 class="mb-4 text-4xl md:text-5xl text-darkCoolGray-900 font-bold tracking-tighter leading-tight">
                Contact Us
              </h1>
              <p class="text-base text-coolGray-500">
            ...
            <div class="w-full mb-14 lg:mb-0">
              <div class="flex flex-wrap ">
                <div class="w-full md:w-1/2 mb-10">
                  <div class="mx-auto">
                    <div class="inline-flex mb-6 items-center justify-center w-12 h-12 bg-indigo-900 rounded-full">
                      <svg
                    ...
                    <h3 class="mb-4 text-2xl md:text-3xl font-bold leading-9 text-gray-700">
                      Email
                    </h3>
                    <a
                      class="text-base text-coolGray-500 hover:text-coolGray-600"
                      href="mailto:#"
                    >
                      info@carcheckstatus.co.uk
                    </a>
                  </div>
                </div>
                <div class="w-full md:w-1/2 mb-10">
                  <div class=" mx-auto">
                    ...
                    <p class="text-base text-coolGray-500">+44 20 7930 3357</p>
                  </div>
                </div>
                <div class="w-full md:w-1/2 mb-10 md:mb-0">
                  <div class="mx-auto">
                    ...
                    <p class="text-base text-coolGray-500">20 Irving St,</p>
                    <p class="text-base text-coolGray-500">
                      London WC2H 7AU, UK
                    </p>
                  </div>
                ...
                <div class="w-full md:w-1/2 ">
                  <div class=" mx-auto">
                    ...
                    <h3 class="mb-9 text-2xl md:text-3xl font-bold leading-9 text-gray-700">
                      Office Hours
                    </h3>
                    <p class="text-base text-coolGray-500">
          ...
          <p class="text-base text-coolGray-500">
            Thank you for using Car Check Status.
          </p>
        </div>
      </section>
    </>
